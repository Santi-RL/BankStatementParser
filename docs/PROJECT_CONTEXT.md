...
### `parser_specs/`
Contiene el registro declarativo versionado por banco/formato. Cada formato tiene su `spec.toml` y sus fixtures sanitizadas. Hoy Galicia, Chase, Roela, BBVA y Mercado Pago ya están migrados a este modelo, incluyendo dos variantes publicadas de BBVA.
...
- La suite actual valida formatos declarativos publicados para Galicia, Chase, Roela, BBVA y Mercado Pago.
